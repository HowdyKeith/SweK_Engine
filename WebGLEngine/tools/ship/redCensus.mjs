...
export const FIXED_SINCE_V4279 = Object.freeze([
    { gate: "tools/ship/gateBudget-selfcheck.mjs", round: "v4325 -- pruned here; the REPAIR was v4304's",
      why: "NOT FIXED BY v4325; FOUND STALE BY IT. The failing line this census recorded is 'the recorded " +
    ...
    { gate: "tools/ship/orrery-selfcheck.mjs", round: "v4325",
    ...
    { gate: "tools/ship/orrerySeed-selfcheck.mjs", round: "v4325",
    ...
    { gate: "tools/ship/orreryView-selfcheck.mjs", round: "v4325",
