...
//
// ---- *** v4381 -- THE COUNT WAS THE TRIGGER FOR AN ARCHITECTURAL DECISION AND THE TRIGGER WAS MISREAD. ***
//
...
{
    // v4381 -- MEASURED WITH classify(), against v1's 14 measured on raw text. It is not comparable to v3274's
    ...
    ok("!! ...and a file that MENTIONS both is not a file that IMPLEMENTS both",
        // v4381 -- THIS IS NOW A LIVE CHECK. v1 hard-coded its own filename into the census's SKIP list, so the
