...
// v4084 -- blobThermal carried the same undeclared-observable defect, found by checking it against this list.
import { buildBlob, blobThermalDevice } from "../roundhouse/blobThermalBind.mjs";
...
// 7. declared observables are honest -- every key a build returns is declared
{
    const checks = [["optics", buildOptics, opticsDevice, ["airy", "slit", "edge", "converge"]],
                    ...
                    // v4084 -- SAME SHAPE AGAIN: kind undeclared on every mode, plus dInput/msd/walkers on
                    // einstein and horizons on scheme, found the same way v3850 and v4082 found theirs.
                    ["blobThermal", buildBlob, blobThermalDevice,
                        ["einstein", "scheme", "floor", "dispersion", "plasmalens"]]];
