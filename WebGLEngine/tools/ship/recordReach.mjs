...
export const REACH_AT_V4548 = Object.freeze({
    ...
    // v4651 -- 148 -> 149: EXILED_PASS_V4651 in tools/ship/sweepCoverage.mjs. It arrives GUARDED --
...
export const UNGUARDED_SPLIT_V4577 = Object.freeze({
    ...
    // v4651 -- 148 -> 149, the one arrival re-taken above; `unguarded` does not move.
