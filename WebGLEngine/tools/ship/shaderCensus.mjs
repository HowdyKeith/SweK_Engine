...
//
// ---- *** v4381 -- THE COUNT THIS FILE FEEDS IS A TRIGGER FOR AN ARCHITECTURAL DECISION, AND IT WAS MEASURED
...
// across this tree at v4381: FOUR of the fourteen files it called shader PAIRS carry no GLSL at all, and
...
export function shaderCensus(root) {
    ...
    const walk = (dir) => {
        ...
        for (const e of ents) {
            ...
            // over the quick sweep's 3 s budget at v4381 -- out of the sweep that runs every round and into the
