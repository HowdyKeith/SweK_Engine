...
export const MEASURED = {
    ...
    // *** v4457 -- MEASURED AT BIRTH, so it never enters the "never run" state the entry above was rescued from. ***
    // tools/ship/slugWgsl-selfcheck.mjs runs the WGSL Slug core on the headless Dawn device over ~130,000
    // samples across eight dispatches, plus five compiles and two dilation probes; that is over the quick
