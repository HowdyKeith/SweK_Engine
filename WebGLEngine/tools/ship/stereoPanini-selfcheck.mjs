// WebGLEngine/tools/ship/stereoPanini-selfcheck.mjs -- v4463 (main's tools/ship/stereographic-selfcheck.mjs, moved at the v4526 merge:
// this branch's v4499 gate of render/stereographic.mjs, the little planet, already held that path; this one grades render/stereographic.js)
//
// Run: node tools/ship/stereoPanini-selfcheck.mjs
//
...
console.log("stereoPanini-selfcheck: " + (fails ? fails + " FAILED" : "all pass"));
