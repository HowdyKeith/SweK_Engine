...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 94,
   "first": "!! *** every gate carries evidence about its own runtime, or admits that it does not finish ***   4 with none -- tools/roundhouse/modeDistinct-selfcheck.mjs, tools/ship/divineEye-selfcheck.mjs, tools/ship/registerDrift-selfcheck.mjs, tools/ship/traderPolicy-selfcheck.mjs",
   "all": [
    "!! *** every gate carries evidence about its own runtime, or admits that it does not finish ***   4 with none -- tools/roundhouse/modeDistinct-selfcheck.mjs, tools/ship/divineEye-selfcheck.mjs, tools/ship/registerDrift-selfcheck.mjs, tools/ship/traderPolicy-selfcheck.mjs"
   ],
   "count": 1,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 76210,
   "first": "!! *** the prose-rescued population may only SHRINK ***   223 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
   "all": [
    "!! *** the prose-rescued population may only SHRINK ***   223 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve."
   ],
   "count": 1,
   "onStderr": false
  },
  ...
  {
   "gate": "tools/ship/shaderCensus-selfcheck.mjs",
   "exit": 1,
   "ms": 318,
   "first": "!! *** only 14 files author a shader in BOTH languages ***   fx/nebula/nebulaShaders.js, fx/wormhole/wormholeNebula.js, render/blackbodyWgsl.mjs, render/bloomFused.mjs, render/fleetMask.mjs, render/fleetTsl.mjs, render/fleets.mjs, render/gpuDriven.mjs, render/gpuTerrain.mjs, render/lyapunovWgsl.mjs, render/tslSource.mjs, render/wgslSpec.mjs, tools/roundhouse/magmapVariants.mjs, tools/ship/wgslCorpus.mjs -- against 24 WGSL-only and 169 GLSL-only, which never needed translating. AN IR FOR THREE CONSUMERS WOULD BE A THIRD THING TO MAINTAIN BESIDE THE TWO IT REPLACED. If this count climbs toward twenty the arithmetic inverts, and THAT is when to re-open llvm-tutorial-book's three-stage shape: parse, lower to an IR, emit per target",
   "all": [
    "!! *** only 14 files author a shader in BOTH languages ***   fx/nebula/nebulaShaders.js, fx/wormhole/wormholeNebula.js, render/blackbodyWgsl.mjs, render/bloomFused.mjs, render/fleetMask.mjs, render/fleetTsl.mjs, render/fleets.mjs, render/gpuDriven.mjs, render/gpuTerrain.mjs, render/lyapunovWgsl.mjs, render/tslSource.mjs, render/wgslSpec.mjs, tools/roundhouse/magmapVariants.mjs, tools/ship/wgslCorpus.mjs -- against 24 WGSL-only and 169 GLSL-only, which never needed translating. AN IR FOR THREE CONSUMERS WOULD BE A THIRD THING TO MAINTAIN BESIDE THE TWO IT REPLACED. If this count climbs toward twenty the arithmetic inverts, and THAT is when to re-open llvm-tutorial-book's three-stage shape: parse, lower to an IR, emit per target"
   ],
   "count": 1,
   "onStderr": false
  },
