...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 104,
   "first": "!! *** every gate carries evidence about its own runtime, or admits that it does not finish ***   4 with none -- tools/roundhouse/modeDistinct-selfcheck.mjs, tools/ship/divineEye-selfcheck.mjs, tools/ship/mutationScore-selfcheck.mjs, tools/ship/traderPolicy-selfcheck.mjs",
   "all": [
    "!! *** every gate carries evidence about its own runtime, or admits that it does not finish ***   4 with none -- tools/roundhouse/modeDistinct-selfcheck.mjs, tools/ship/divineEye-selfcheck.mjs, tools/ship/mutationScore-selfcheck.mjs, tools/ship/traderPolicy-selfcheck.mjs"
   ],
   "count": 1,
   "onStderr": false
  },
