...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 97412,
   "first": "!! ORPHANED UTILITIES HAVE NOT INCREASED   158 now vs 93 recorded. These export functions and NOTHING calls them -- wire it, or delete it. This is the number that means something; the total includes analysis records whose consumer is correctly the gate.",
   "all": [
    "!! ORPHANED UTILITIES HAVE NOT INCREASED   158 now vs 93 recorded. These export functions and NOTHING calls them -- wire it, or delete it. This is the number that means something; the total includes analysis records whose consumer is correctly the gate."
   ],
   "count": 1,
   "onStderr": false
  },
