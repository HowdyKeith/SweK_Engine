...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 241,
   "first": "!! no NEW exported symbol under physics/ has appeared without its gate naming it   GREW to 22: physics/crypto/secp256k1.mjs:pointDouble, physics/mesh/meshCSG.mjs:planeOf, physics/mesh/meshCSG.mjs:polyAABB, physics/mesh/meshCSG.mjs:polysAABB, physics/mesh/meshCSG.mjs:toTriangles, physics/mesh/meshCSG.mjs:toTriangleBuffer ...",
   "all": [
    "!! no NEW exported symbol under physics/ has appeared without its gate naming it   GREW to 22: physics/crypto/secp256k1.mjs:pointDouble, physics/mesh/meshCSG.mjs:planeOf, physics/mesh/meshCSG.mjs:polyAABB, physics/mesh/meshCSG.mjs:polysAABB, physics/mesh/meshCSG.mjs:toTriangles, physics/mesh/meshCSG.mjs:toTriangleBuffer ...",
    "!! no NEW exported symbol ANYWHERE IN THE TREE has appeared without its gate naming it   GREW to 266: ai-bridge/chunkVerify.mjs:verifiedPrefix, ai-bridge/chunkVerify.mjs:resumePlan, ai-bridge/chunkVerify.mjs:spliceRanges, ai-bridge/chunkVerify.mjs:chunkAudit, ai-bridge/chunkVerify.mjs:resumeRanges, ai-bridge/deviceWorker.mjs:offThreadDevice ..."
   ],
   "count": 2,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 87646,
   "first": "!! *** the prose-rescued population may only SHRINK ***   243 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
   "all": [
    "!! *** the prose-rescued population may only SHRINK ***   243 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
