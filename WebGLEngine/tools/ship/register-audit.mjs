...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 90796,
   "first": "!! *** the prose-rescued population may only SHRINK ***   269 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
   "all": [
    "!! *** the prose-rescued population may only SHRINK ***   269 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
    "!! *** no NEW module is hidden from the orphan census by the ship ritual's own sweep closing ***   23 against 2: brain/rl/attribution.mjs, core/ecs/index.js, ev/tools/es-arena.mjs, gfx/pipelineGaps.mjs, mesh/carve.mjs, physics/render/transmission.mjs, render/img2three.mjs, render/panini.js, render/shaderEmitters.mjs, text/slugShaderWgsl.js, tools/mutate/mutate.mjs, tools/roundhouse/zeroRangeFull.mjs, tools/ship/claimEvidence.mjs, tools/ship/closingCoverage.mjs, tools/ship/coverageTriage.mjs, tools/ship/emitReproducibility.mjs, tools/ship/gateReport.mjs, tools/ship/glslFloatPack.mjs, tools/ship/observedGates.mjs, tools/ship/shipVerdict.mjs, tools/ship/sweepRotation.mjs, tools/ship/vacuity.mjs, vba/runtimeGap.mjs. THE CLOSING IS WRITTEN BY THE RITUAL, one per round that adds a gate, and it names the module it guards -- so a round that builds a module, gates it and ships it has documented the module into invisibility without deciding to. The two standing are render/img2three.mjs (a three.js-object-tree flattener whose only caller today is its own gate; no page builds a three tree to flatten) and mesh/carve.mjs. Falling is progress by the three routes this file has always named -- wire it, delete it, or teach the census to resolve."
   ],
   "count": 2,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 439821,
   "first": "!! the hand-spelled corpus filters are COUNTED, not swept   20 callers still spell /\\.(js|mjs|html)$/ by hand: mesh/greedyMesh-selfcheck.mjs, render/backendParity.mjs, render/colourReach.mjs, render/shaderEmitters.mjs, tools/ship/canvasFill-selfcheck.mjs, tools/ship/deviceReach-selfcheck.mjs, tools/ship/glbTexture-selfcheck.mjs, tools/ship/graveyard-selfcheck.mjs, tools/ship/moduleRefs-selfcheck.mjs, tools/ship/orphanTriage.mjs, tools/ship/pageReflow-selfcheck.mjs, tools/ship/ragdollFromSkeleton-selfcheck.mjs, tools/ship/referenceKind-selfcheck.mjs, tools/ship/roundTrip-selfcheck.mjs, tools/ship/toolFrontDoor-selfcheck.mjs, tools/ship/videoFrames-selfcheck.mjs, tools/ship/wasmSupport-selfcheck.mjs, tools/ship/wgslSpec-selfcheck.mjs, tools/ship/wiringClaims.mjs, ui/webgpuProbe-selfcheck.mjs. *** THE ANTIDOTE, WRITTEN IN ADVANCE: as callers import SOURCE_EXT this number FALLS -- DO NOT RAISE IT past 11, and DO NOT rewrite all of them in one script, which is v3202's sweep that deleted 61 live modules. ***",
   "all": [
    "!! the hand-spelled corpus filters are COUNTED, not swept   20 callers still spell /\\.(js|mjs|html)$/ by hand: mesh/greedyMesh-selfcheck.mjs, render/backendParity.mjs, render/colourReach.mjs, render/shaderEmitters.mjs, tools/ship/canvasFill-selfcheck.mjs, tools/ship/deviceReach-selfcheck.mjs, tools/ship/glbTexture-selfcheck.mjs, tools/ship/graveyard-selfcheck.mjs, tools/ship/moduleRefs-selfcheck.mjs, tools/ship/orphanTriage.mjs, tools/ship/pageReflow-selfcheck.mjs, tools/ship/ragdollFromSkeleton-selfcheck.mjs, tools/ship/referenceKind-selfcheck.mjs, tools/ship/roundTrip-selfcheck.mjs, tools/ship/toolFrontDoor-selfcheck.mjs, tools/ship/videoFrames-selfcheck.mjs, tools/ship/wasmSupport-selfcheck.mjs, tools/ship/wgslSpec-selfcheck.mjs, tools/ship/wiringClaims.mjs, ui/webgpuProbe-selfcheck.mjs. *** THE ANTIDOTE, WRITTEN IN ADVANCE: as callers import SOURCE_EXT this number FALLS -- DO NOT RAISE IT past 11, and DO NOT rewrite all of them in one script, which is v3202's sweep that deleted 61 live modules. ***"
   ],
   "count": 1,
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 3554,
   "first": "!! 82 files mention .wasm or the WebAssembly API -- the item's number, and it is the loose one   103 mention it",
   "all": [
    "!! 82 files mention .wasm or the WebAssembly API -- the item's number, and it is the loose one   103 mention it",
    "!! ...but 16 of those are comments and prose only; 66 mention it in live code   82 in code, 21 comment-only"
   ],
   "count": 2,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 82231,
   "first": "!! ORPHANED UTILITIES HAVE NOT INCREASED   152 now vs 93 recorded. These export functions and NOTHING calls them -- wire it, or delete it. This is the number that means something; the total includes analysis records whose consumer is correctly the gate.",
   "all": [
    "!! ORPHANED UTILITIES HAVE NOT INCREASED   152 now vs 93 recorded. These export functions and NOTHING calls them -- wire it, or delete it. This is the number that means something; the total includes analysis records whose consumer is correctly the gate."
   ],
   "count": 1,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 4101,
   "first": "and across 4453 files requiredLimits appears 5 times -- every device in this tree runs at the defaults, so a 1024-wide workgroup is not merely unportable, it cannot be created here",
   "all": [
    "and across 4453 files requiredLimits appears 5 times -- every device in this tree runs at the defaults, so a 1024-wide workgroup is not merely unportable, it cannot be created here"
   ],
   "count": 1,
   "onStderr": false
  }
