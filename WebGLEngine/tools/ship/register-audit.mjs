...
export const REGISTER_AUDIT = Object.freeze({
 ...
 "rows": [
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 237,
   "first": "!! no NEW exported symbol under physics/ has appeared without its gate naming it   GREW to 46: physics/crypto/secp256k1.mjs:pointDouble, physics/mesh/meshCSG.mjs:planeOf, physics/mesh/meshCSG.mjs:polyAABB, physics/mesh/meshCSG.mjs:polysAABB, physics/mesh/meshCSG.mjs:toTriangles, physics/mesh/meshCSG.mjs:toTriangleBuffer ...",
   "all": [
    "!! no NEW exported symbol under physics/ has appeared without its gate naming it   GREW to 46: physics/crypto/secp256k1.mjs:pointDouble, physics/mesh/meshCSG.mjs:planeOf, physics/mesh/meshCSG.mjs:polyAABB, physics/mesh/meshCSG.mjs:polysAABB, physics/mesh/meshCSG.mjs:toTriangles, physics/mesh/meshCSG.mjs:toTriangleBuffer ...",
    "!! no NEW exported symbol ANYWHERE IN THE TREE has appeared without its gate naming it   GREW to 294: ai-bridge/chunkVerify.mjs:verifiedPrefix, ai-bridge/chunkVerify.mjs:resumePlan, ai-bridge/chunkVerify.mjs:spliceRanges, ai-bridge/chunkVerify.mjs:chunkAudit, ai-bridge/chunkVerify.mjs:resumeRanges, ai-bridge/deviceWorker.mjs:offThreadDevice ..."
   ],
   "count": 2,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 95,
   "first": "!! ...and the silent bucket is the large one, which is the finding   204 silent against 239 placed. pageSections says of UNPLACED: \"an unplaced page and a page nobody has got to look identical, and the second one gets placed by a guess.\" *** UNPLACED HOLDS 23. THE OTHER 204 ARE IN EXACTLY THE STATE THE MECHANISM EXISTS TO PREVENT. ***",
   "all": [
    "!! ...and the silent bucket is the large one, which is the finding   204 silent against 239 placed. pageSections says of UNPLACED: \"an unplaced page and a page nobody has got to look identical, and the second one gets placed by a guess.\" *** UNPLACED HOLDS 23. THE OTHER 204 ARE IN EXACTLY THE STATE THE MECHANISM EXISTS TO PREVENT. ***",
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 90592,
   "first": "!! *** the prose-rescued population may only SHRINK ***   267 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
   "all": [
    "!! *** the prose-rescued population may only SHRINK ***   267 against a ceiling of 181. A RISE MEANS A NEW ORPHAN IS BEING HIDDEN BY A SENTENCE. Falling is progress by any of three routes -- wire it, delete it, or teach the census to resolve.",
    "!! *** no NEW module is hidden from the orphan census by the ship ritual's own sweep closing ***   29 against 2: brain/rl/attribution.mjs, brain/transport/scanTwin.mjs, core/ecs/index.js, engine/loop.js, ev/tools/es-arena.mjs, mesh/carve.mjs, physics/render/transmission.mjs, physics/render/wgslArc.mjs, render/img2three.mjs, render/panini.js, render/slugTsl.mjs, render/texelProbe.mjs, tools/mutate/mutate.mjs, tools/roundhouse/zeroRangeFull.mjs, tools/ship/absenceScope.mjs, tools/ship/claimEvidence.mjs, tools/ship/closingCoverage.mjs, tools/ship/gateReport.mjs, tools/ship/packFonts.mjs, tools/ship/recordDrift.mjs, tools/ship/refusalStack.mjs, tools/ship/shipVerdict.mjs, tools/ship/sweepRotation.mjs, tools/ship/textureBytes.mjs, tools/ship/todo.mjs, tools/ship/vacuity.mjs, tools/ship/wgslCorpus.mjs, vba/runtimeGap.mjs, world/vendoredLicences.mjs. THE CLOSING IS WRITTEN BY THE RITUAL, one per round that adds a gate, and it names the module it guards -- so a round that builds a module, gates it and ships it has documented the module into invisibility without deciding to. The two standing are render/img2three.mjs (a three.js-object-tree flattener whose only caller today is its own gate; no page builds a three tree to flatten) and mesh/carve.mjs. Falling is progress by the three routes this file has always named -- wire it, delete it, or teach the census to resolve."
   ],
   "count": 2,
   "onStderr": false
  },
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 2526,
   "first": "!! 82 files mention .wasm or the WebAssembly API -- the item's number, and it is the loose one   107 mention it",
   "all": [
    "!! 82 files mention .wasm or the WebAssembly API -- the item's number, and it is the loose one   107 mention it",
    "!! ...but 16 of those are comments and prose only; 66 mention it in live code   85 in code, 22 comment-only",
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 83844,
   "first": "!! 'imported by a gate named for something else' holds for EVERY member  -- 27 of 29",
   "all": [
    "!! 'imported by a gate named for something else' holds for EVERY member  -- 27 of 29",
  ...
  },
  {
   ...
   "exit": 1,
   "ms": 2594,
   "first": "and across 4582 files requiredLimits appears 5 times -- every device in this tree runs at the defaults, so a 1024-wide workgroup is not merely unportable, it cannot be created here",
   "all": [
    "and across 4582 files requiredLimits appears 5 times -- every device in this tree runs at the defaults, so a 1024-wide workgroup is not merely unportable, it cannot be created here"
   ],
   "count": 1,
   "onStderr": false
  },
