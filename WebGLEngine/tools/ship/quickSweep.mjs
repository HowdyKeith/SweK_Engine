...
import { RED_AT_V4279, RED_AT_V4408, RED_AT_V4424, RED_AT_V4476, RED_AT_V4484, RED_AT_V4531, RED_AT_V4534, UNCONFIRMED_SLOW } from "./redCensus.mjs";
...
export function redRegister() {
    ...
    for (const e of RED_AT_V4534) reg.set(e.gate, "redCensus.RED_AT_V4534");
