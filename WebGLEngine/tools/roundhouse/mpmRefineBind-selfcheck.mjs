...
console.log("\n2. THE FIXTURE MUST BE THE SAME PROBLEM AT EVERY LEVEL");
{
    ...
    // *** v3849 -- AND THE DECLARED OBSERVABLE MUST SATISFY THE CENSUS'S CONTRACT, WHICH IS THE THING THAT
    // WAS ACTUALLY BROKEN AND WHICH NO CHECK HERE WAS ASKING. *** This device declared `fixtureInvariant`, a
    // BOOLEAN, from v3802 to v3849. The plant fired the whole time -- this gate's own section 3 proves it --
    ...
    ok("...and the boolean is DERIVED from that number, so the two cannot disagree",
        ...
        "SAME MEASUREMENT, rather than two thresholds computed beside each other");
}
