 ...
 */
export function basisFromNormal(origin, normal) {
 ...
 */
export function basisFromNormalAndX(origin, normal, preferX) {
    const z = normalize(normal);
...
export function planePoint(b, u, v) {
    return [
...
export function toPlaneCoords(b, p) {
