...
export function symmetric(m00, m01, m02, m11, m12, m22) {
...
export function col(m, c) {
    return [m[c], m[c + 3], m[c + 6]];
}
/** Row r of the matrix. */
export function row(m, r) {
    const o = r * 3;
    return [m[o], m[o + 1], m[o + 2]];
}
export function addM(a, b) {
    return [
...
export function quadForm(m, a, b) {
