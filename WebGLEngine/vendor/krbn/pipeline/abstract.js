...
export function screenExtent(curve) {
    switch (curve.kind) {
        case "line":
 ...
 */
export function cutoffFor(importance, baseCutoffPx) {
...
export function applyAbstraction(strokes, opts) {
    if (opts.minFeaturePx <= 0)
        return [...strokes];
...
export function quantizeTone(tone, levels) {
    if (levels <= 0)
        return tone;
