...
const BRAIN_BUILD = "v4213";   // v4213 -- haptics as data: the tree had none, and the two playback APIs cannot express each other. Full changelog on docs/CHANGELOG.md.
