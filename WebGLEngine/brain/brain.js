...
const BRAIN_BUILD = "v4242";   // v4242 -- the post chain measured across configurations rather than once: a gate check that read a non-existent property reported SSAO disabled while it ran at 0.85, the frame is 5 to 8 draws depending on SSAO, phosphor and the time of day, and three of the five "optional passes" cannot enter the frame at all. Full changelog on docs/CHANGELOG.md.
