...
const BRAIN_BUILD = "v4239";   // v4239 -- a world-space fold for streamed geometry, and the measurement that says a deformation is LOD-safe exactly when it is a pure function of position. Full changelog on docs/CHANGELOG.md.
