...
const BRAIN_BUILD = "v4177";   // v4177 -- no brain change; version kept in lockstep with ENGINE_VERSION (one Ashima simplex instead of two, and the aquarelle dissolve ported off four dead three.js APIs). Full changelog on docs/CHANGELOG.md.
