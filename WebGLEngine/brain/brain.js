...
const BRAIN_BUILD = "v4142";   // v4142 -- no brain change; version kept in lockstep with ENGINE_VERSION (install-steamdeck.sh gained an optional adb step for Shield/Android TV control). Full changelog on docs/CHANGELOG.md.
