...
const BRAIN_BUILD = "v4187";   // v4187 -- no brain change; version kept in lockstep with ENGINE_VERSION (dungeon monsters stop walking through walls, and wall-follow instead of stalling). Full changelog on docs/CHANGELOG.md.
