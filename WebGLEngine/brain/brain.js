...
const BRAIN_BUILD = "v4206";   // v4206 -- a gunnery policy joins the brain (brain/navalPolicy.mjs), same weight-vector shape as csTacticsPolicy. Full changelog on docs/CHANGELOG.md.
