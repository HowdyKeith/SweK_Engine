...
const BRAIN_BUILD = "v4171";   // v4171 -- no brain change; version kept in lockstep with ENGINE_VERSION (budget hygiene before the next rig run: 26 bases raised to their own measurements, 23 untimed gates timed). Full changelog on docs/CHANGELOG.md.
