...
const BRAIN_BUILD = "v4199";   // v4199 -- no brain change; version kept in lockstep with ENGINE_VERSION (dom disintegration, elastic easing, download progress). Full changelog on docs/CHANGELOG.md.
