...
const BRAIN_BUILD = "v4178";   // v4178 -- no brain change; version kept in lockstep with ENGINE_VERSION (the DOOM fire, seeded so it can be graded). Full changelog on docs/CHANGELOG.md.
