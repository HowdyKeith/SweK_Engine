...
const BRAIN_BUILD = "v4250";   // v4250 -- a deterministic rAF: every frame draws (6 per step, exactly), and v4242's 89% survives a clock with no race in it -- nine rAF consumers, one renderer. It was architecture, not swiftshader. Full changelog on docs/CHANGELOG.md.
