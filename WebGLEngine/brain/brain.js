...
const BRAIN_BUILD = "v4170";   // v4170 -- no brain change; version kept in lockstep with ENGINE_VERSION (the v4122 neighbour-grid instrument fixed; it read a vestigial field and never threw). Full changelog on docs/CHANGELOG.md.
