...
const BRAIN_BUILD = "v4147";   // v4147 -- no brain change; version kept in lockstep with ENGINE_VERSION (Steam Deck peer button, page and detector, plus the Bun mDNS guard narrowed to Windows so a Deck keeps .local discovery). Full changelog on docs/CHANGELOG.md.
