...
const BRAIN_BUILD = "v4081";   // v4081 -- RIG LAB's Gemini creature generator now shows "Gemini needs Key" up front (via window.ai.keyStatus()) instead of only after a failed generate, with a link to Settings' "discord" (Connectors) category, where the geminiKey control actually lives. New tools/ship/rigLabGeminiKey-selfcheck.mjs. Full changelog on docs/CHANGELOG.md.
