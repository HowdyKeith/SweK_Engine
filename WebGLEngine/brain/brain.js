...
const BRAIN_BUILD = "v4226";   // v4226 -- vision/homography.mjs: the plane-to-plane map by normalised DLT plus RANSAC, the first piece of mind-ar-js this tree can use. Full changelog on docs/CHANGELOG.md.
