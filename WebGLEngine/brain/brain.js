...
const BRAIN_BUILD = "v4244";   // v4244 -- skeleton retargeting: a naive quaternion copy is wrong by exactly the rest-pose angle (0.9 rad, 51.57 degrees), and the round trip #115 asked for cannot see it because the naive algorithm round-trips perfectly too. Full changelog on docs/CHANGELOG.md.
