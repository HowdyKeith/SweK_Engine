...
const BRAIN_BUILD = "v4193";   // v4193 -- no brain change; version kept in lockstep with ENGINE_VERSION (a clip as a reproducible input to the effect chain). Full changelog on docs/CHANGELOG.md.
