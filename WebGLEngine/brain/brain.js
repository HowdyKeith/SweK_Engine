...
const BRAIN_BUILD = "v4174";   // v4174 -- no brain change; version kept in lockstep with ENGINE_VERSION (Draco routing, dirty-flag rendering, sprite slicing). Full changelog on docs/CHANGELOG.md.
