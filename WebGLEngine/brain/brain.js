...
const BRAIN_BUILD = "v4143";   // v4143 -- no brain change; version kept in lockstep with ENGINE_VERSION (a new install button for schildep/verified-polygon-intersection). Full changelog on docs/CHANGELOG.md.
