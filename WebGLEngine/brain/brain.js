...
const BRAIN_BUILD = "v4189";   // v4189 -- no brain change; version kept in lockstep with ENGINE_VERSION (the git log as the universe's seed, and a gas giant that painted nothing). Full changelog on docs/CHANGELOG.md.
