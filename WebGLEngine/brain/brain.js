...
const BRAIN_BUILD = "v4180";   // v4180 -- no brain change; version kept in lockstep with ENGINE_VERSION (SVG path measurement in pure JS, and the self-drawing line). Full changelog on docs/CHANGELOG.md.
