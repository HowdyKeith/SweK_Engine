...
const BRAIN_BUILD = "v4238";   // v4238 -- a GPU perspective warp for the homography module that shipped without one, and the second hand-rolled projective solver it turns out the tree already had. Full changelog on docs/CHANGELOG.md.
