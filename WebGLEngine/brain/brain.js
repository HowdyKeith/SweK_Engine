...
const BRAIN_BUILD = "v4152";   // v4152 -- no brain change; version kept in lockstep with ENGINE_VERSION (a child process is not a socket, and loop turns cannot reap one). Full changelog on docs/CHANGELOG.md.
