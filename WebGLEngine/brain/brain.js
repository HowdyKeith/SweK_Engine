...
const BRAIN_BUILD = "v4196";   // v4196 -- no brain change; version kept in lockstep with ENGINE_VERSION (five shader ports, a toHalf NaN, the GLSL actually run). Full changelog on docs/CHANGELOG.md.
