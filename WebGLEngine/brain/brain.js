...
const BRAIN_BUILD = "v4208";   // v4208 -- the brain transport shaders now fit a default device: workgroup 1024 -> 256 with strided loops, verified in brain/transport/scanTwin.mjs. Full changelog on docs/CHANGELOG.md.
