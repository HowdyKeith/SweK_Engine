...
const BRAIN_BUILD = "v4197";   // v4197 -- no brain change; version kept in lockstep with ENGINE_VERSION (mic effect chains, offline determinism, stagger as data). Full changelog on docs/CHANGELOG.md.
