...
const BRAIN_BUILD = "v4304";   // v4304 -- *** THE BACKLOG'S LICENCE VERDICTS ARE IN THE TREE, THE AVATAR WALKS IN DEPTH, AND THE DOCK HAS A RULER. *** Eighteen repositories the open list had judged from memory (#106 #100 #132 #63 #122) were opened from shallow clones and now carry first-hand evidence in world/licenceSweep.mjs and a judgement in world/reachedLicences.mjs; four of the six UNCHECKED names left that register, two stay because no owner can be found for them. face/avatarStage.js wanders in z as well as x (#85), tools/ship/dockFraming.mjs measures the dock's coverage noise floor (#86: 0.255 +/- 0.011, so #83's crop-vertically candidate at 0.312 is a real change, not wander), knobLiveness's real-plant probe is unconditional (#38, 423,693 ms measured), budgetEvidence and gateBudget are green and off the red register. The tree stands at 1387 gates. Full changelog on docs/CHANGELOG.md.
