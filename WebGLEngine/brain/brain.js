...
const BRAIN_BUILD = "v4166";   // v4166 -- no brain change; version kept in lockstep with ENGINE_VERSION (four rig gates fixed; the budget estimator was reading its own headroom as host slowness). Full changelog on docs/CHANGELOG.md.
