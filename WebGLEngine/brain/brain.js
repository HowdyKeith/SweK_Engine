...
const BRAIN_BUILD = "v4227";   // v4227 -- render/glCapture.mjs: record a context the PAGE made and compile it back into code that replays to the same pixel. Full changelog on docs/CHANGELOG.md.
