...
const BRAIN_BUILD = "v4182";   // v4182 -- no brain change; version kept in lockstep with ENGINE_VERSION (the bad-TV signal pass, and the 2D simplex it finally consumes). Full changelog on docs/CHANGELOG.md.
