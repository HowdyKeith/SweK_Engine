...
const BRAIN_BUILD = "v4162";   // v4162 -- no brain change; version kept in lockstep with ENGINE_VERSION (the equation of state pinned, and three gates that asserted a stopwatch corrected). Full changelog on docs/CHANGELOG.md.
