...
const BRAIN_BUILD = "v4207";   // v4207 -- no brain change; version kept in lockstep with ENGINE_VERSION (a WGSL conformance check, three of whose findings are the brain transport kernels). Full changelog on docs/CHANGELOG.md.
