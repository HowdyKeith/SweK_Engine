...
const BRAIN_BUILD = "v4194";   // v4194 -- no brain change; version kept in lockstep with ENGINE_VERSION (reduced motion, sfx themes, a real mute). Full changelog on docs/CHANGELOG.md.
