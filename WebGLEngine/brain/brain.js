...
const BRAIN_BUILD = "v4190";   // v4190 -- no brain change; version kept in lockstep with ENGINE_VERSION (sound effects as data, hashable and click-free). Full changelog on docs/CHANGELOG.md.
