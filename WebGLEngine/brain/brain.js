...
const BRAIN_BUILD = "v4191";   // v4191 -- no brain change; version kept in lockstep with ENGINE_VERSION (the DOM as a frameDirty source). Full changelog on docs/CHANGELOG.md.
