...
const BRAIN_BUILD = "v4245";   // v4245 -- a ragdoll joint graph derived from a bone hierarchy instead of typed out twice: the obvious body-per-bone box puts 4 of 10 joint anchors outside the body they attach to, and enclosing every child head fixes it. Full changelog on docs/CHANGELOG.md.
