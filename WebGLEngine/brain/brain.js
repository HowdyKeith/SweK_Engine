...
const BRAIN_BUILD = "v4184";   // v4184 -- no brain change; version kept in lockstep with ENGINE_VERSION (the census used, and the HUD readout moved out of the draw guard). Full changelog on docs/CHANGELOG.md.
