...
const BRAIN_BUILD = "v4183";   // v4183 -- no brain change; version kept in lockstep with ENGINE_VERSION (the frameDirty census, and the two ratchets that keep it one). Full changelog on docs/CHANGELOG.md.
