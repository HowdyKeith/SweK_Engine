...
const BRAIN_BUILD = "v4210";   // v4210 -- server.html's Phone Mode button now shows the scan-to-connect QR instead of opening the phone UI on the PC. Full changelog on docs/CHANGELOG.md.
