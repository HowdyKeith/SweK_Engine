...
const BRAIN_BUILD = "v4201";   // v4201 -- no brain change; version kept in lockstep with ENGINE_VERSION (numerical inversion of any pure function). Full changelog on docs/CHANGELOG.md.
