...
const BRAIN_BUILD = "v4176";   // v4176 -- no brain change; version kept in lockstep with ENGINE_VERSION (scene export with viewpoint and atmosphere recipe, and the viewer at the far end). Full changelog on docs/CHANGELOG.md.
