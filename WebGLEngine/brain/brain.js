...
const BRAIN_BUILD = "v4175";   // v4175 -- no brain change; version kept in lockstep with ENGINE_VERSION (the Khronos catalogue, its licence postures, and a real Draco GLB for the router). Full changelog on docs/CHANGELOG.md.
