...
const BRAIN_BUILD = "v4192";   // v4192 -- no brain change; version kept in lockstep with ENGINE_VERSION (the spell book, priced by measurement). Full changelog on docs/CHANGELOG.md.
