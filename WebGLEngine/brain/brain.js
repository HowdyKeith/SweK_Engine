...
const BRAIN_BUILD = "v4247";   // v4247 -- gaze-dwell selection for a headset with no controller: a resetting dwell never completes under 35.6% off-target frames while a decaying one does, and the decay rate's tremor tolerance is the closed form p < 1/(1+decay). Full changelog on docs/CHANGELOG.md.
