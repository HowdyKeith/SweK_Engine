...
const BRAIN_BUILD = "v4235";   // v4235 -- destructible environments: BSP mesh booleans localised through the BVH, an exact hole on the wall's own plane, and "gap-free" separated into a solid that is closed and a mesh that is not welded. Full changelog on docs/CHANGELOG.md.
