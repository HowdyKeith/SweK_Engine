...
const BRAIN_BUILD = "v4237";   // v4237 -- precomputed atmospheric scattering: four closed forms, a lookup table graded against direct integration on one deterministic probe grid, and a sunset that arrives without being asked for. Full changelog on docs/CHANGELOG.md.
