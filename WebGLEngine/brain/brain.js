...
const BRAIN_BUILD = "v4211";   // v4211 -- fluid particles are masked to discs (proven in a CPU twin: coverage pi/4, not 1.0), and the server console grows a Peer 2 Peer panel. Full changelog on docs/CHANGELOG.md.
