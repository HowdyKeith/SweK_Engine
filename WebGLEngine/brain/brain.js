...
const BRAIN_BUILD = "v4200";   // v4200 -- no brain change; version kept in lockstep with ENGINE_VERSION (the ENCUMBERED licence posture). Full changelog on docs/CHANGELOG.md.
