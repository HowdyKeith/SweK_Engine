...
const BRAIN_BUILD = "v4203";   // v4203 -- no brain change; version kept in lockstep with ENGINE_VERSION (the licence register quoted three things wrong). Full changelog on docs/CHANGELOG.md.
