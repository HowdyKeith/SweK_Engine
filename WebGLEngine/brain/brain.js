...
const BRAIN_BUILD = "v4248";   // v4248 -- the derived ragdoll runs in box3d: accepted, finite, falls and hangs. But three instruments fail to show v4245's anchor fix improves the simulation, and the drop's chaos floor is 0.455 m. Full changelog on docs/CHANGELOG.md.
