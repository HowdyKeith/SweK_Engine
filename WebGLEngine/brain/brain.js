...
const BRAIN_BUILD = "v4249";   // v4249 -- every derived ragdoll self-overlaps and generates contacts hanging in empty space; the enclosing fix fights itself 148x harder, and box3d_shim.c exposes no collision filtering to turn it off. Full changelog on docs/CHANGELOG.md.
