...
const BRAIN_BUILD = "v4215";   // v4215 -- a timeline that is correct when you scrub: a jump over a clip is reported, not silently dropped. Full changelog on docs/CHANGELOG.md.
