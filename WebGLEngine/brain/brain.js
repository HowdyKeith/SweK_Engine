...
const BRAIN_BUILD = "v4172";   // v4172 -- no brain change; version kept in lockstep with ENGINE_VERSION (grass ported, and the curve half of Bitcoin the miner demo never had). Full changelog on docs/CHANGELOG.md.
