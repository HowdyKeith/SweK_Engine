...
const BRAIN_BUILD = "v4140";   // v4140 -- Steam Deck / Linux peer launcher: brain/start-brain-steamdeck.sh joins the fleet with WGPU_BACKEND=vulkan pinned for the Deck's AMD RDNA2 APU (Mesa RADV, Proton's own Vulkan path), GPU-first with a transparent CPU-Dijkstra fallback on a software-adapter refusal, same shape as start-brain-mac.sh. Full changelog on docs/CHANGELOG.md.
