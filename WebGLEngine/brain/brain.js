...
const BRAIN_BUILD = "v4168";   // v4168 -- no brain change; version kept in lockstep with ENGINE_VERSION (eighteen more device plants merged from the tier-2 branch; its one deletion verified as inert before being taken). Full changelog on docs/CHANGELOG.md.
