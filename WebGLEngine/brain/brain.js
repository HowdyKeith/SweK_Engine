...
const BRAIN_BUILD = "v4204";   // v4204 -- no brain change; version kept in lockstep with ENGINE_VERSION (the GL transition spec as a contract). Full changelog on docs/CHANGELOG.md.
