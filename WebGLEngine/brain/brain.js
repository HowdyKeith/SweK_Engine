...
const BRAIN_BUILD = "v4181";   // v4181 -- no brain change; version kept in lockstep with ENGINE_VERSION (the odometer roll, and its blur proven equal to the original's). Full changelog on docs/CHANGELOG.md.
