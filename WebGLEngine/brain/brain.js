...
const BRAIN_BUILD = "v4141";   // v4141 -- no brain change; version kept in lockstep with ENGINE_VERSION (rig.html gained a sort-by-measured-time option). Full changelog on docs/CHANGELOG.md.
