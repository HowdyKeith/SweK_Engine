...
const BRAIN_BUILD = "v4186";   // v4186 -- no brain change; version kept in lockstep with ENGINE_VERSION (the orrery's view: micro planet to terrain, and three wrong answers that rendered). Full changelog on docs/CHANGELOG.md.
