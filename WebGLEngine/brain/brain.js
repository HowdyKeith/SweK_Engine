...
const BRAIN_BUILD = "v4202";   // v4202 -- no brain change; version kept in lockstep with ENGINE_VERSION (a displacement field that remembers, and the segment distance the tree already had). Full changelog on docs/CHANGELOG.md.
