...
const BRAIN_BUILD = "v4188";   // v4188 -- no brain change; version kept in lockstep with ENGINE_VERSION (camera frames as a GL texture, and the chroma key the tree never had). Full changelog on docs/CHANGELOG.md.
