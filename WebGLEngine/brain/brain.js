...
const BRAIN_BUILD = "v4151";   // v4151 -- no brain change; version kept in lockstep with ENGINE_VERSION (a baseline freeze that caught two unreported defects of my own). Full changelog on docs/CHANGELOG.md.
