...
const BRAIN_BUILD = "v4173";   // v4173 -- no brain change; version kept in lockstep with ENGINE_VERSION (the census measured to completion; a v4166 regression fixed before the rig met it). Full changelog on docs/CHANGELOG.md.
