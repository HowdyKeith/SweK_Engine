...
const BRAIN_BUILD = "v4161";   // v4161 -- no brain change; version kept in lockstep with ENGINE_VERSION (two machines disagreed about the fluid, and the gate was asserting the fragile half of its own sentence). Full changelog on docs/CHANGELOG.md.
