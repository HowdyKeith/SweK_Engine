...
const BRAIN_BUILD = "v4145";   // v4145 -- no brain change; version kept in lockstep with ENGINE_VERSION (six rig-red gates fixed, and an 11-commit patch series from another lineage merged). Full changelog on docs/CHANGELOG.md.
