...
const BRAIN_BUILD = "v4236";   // v4236 -- effect merging: six fullscreen draws a frame measured on the real page through glCapture, one merged draw graded against three chained on a real GPU, and an 8-bit chain that clips rather than rounds. Full changelog on docs/CHANGELOG.md.
