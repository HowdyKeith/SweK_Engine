...
const BRAIN_BUILD = "v4229";   // v4229 -- engine/wasmSupport.mjs: two independent facts reported on their own evidence, so a loader stops telling you to rebuild a working file. Full changelog on docs/CHANGELOG.md.
