...
const BRAIN_BUILD = "v4195";   // v4195 -- no brain change; version kept in lockstep with ENGINE_VERSION (splat round trip, a CRLF defect, a .ply writer). Full changelog on docs/CHANGELOG.md.
