# WebGLEngine/ai-bridge/installers/kill-brain.ps1 -- v3658
#
# Reap a wedged GPU Brain: the deno process whose command line names brain.js, and nothing else.
#
...
#
# MATCHES BY COMMAND LINE ON PURPOSE, so only OUR process dies: a bare "kill every deno.exe" would take out
