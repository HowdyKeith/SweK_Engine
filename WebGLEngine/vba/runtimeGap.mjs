...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    // v4593 -- RE-TAKEN: render/temporalRejectGPU.mjs and its gate, the last two temporal kernels to get a
    // caller. Five rows, and WebGPU unmoved at 49 again for the same reason as v4592: the runner reaches the
    // device through gfx/device.js rather than naming an adapter itself.
    esModules: 3804, closures: 3672, asyncAwait: 1451, typedArrays: 841, promises: 346,
