...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    esModules: 3805, closures: 3684, asyncAwait: 1428, typedArrays: 1042, promises: 350,
    ...
    closuresOverThreads: 167,     // 3682 / 22 at v4549 -- 167.4, unmoved as an integer
