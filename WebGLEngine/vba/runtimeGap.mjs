...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    files: 4316,               // v4675 -- RE-DERIVED: tools/ship/recordProbe.mjs and its gate arrived, TWO ES modules using closures -- and async/await moved by only ONE, which is the shape worth noting: the harness is synchronous throughout (spawnSync, so a guardian's verdict is in hand before the next line runs) while its gate awaits a killed child's exit to prove the signal-safe restore. Four rows moved (files, ES modules 4014 -> 4016, closures 3880 -> 3882, async/await 1542 -> 1543) and eight held -- no typed array, no fetch, no device. closuresOverThreads did NOT move (3882 / 23 still rounds to 169). *** v4674 ADDED NO FILE AT ALL, which is why this line carried a v4673 note until now: that round fixed a cap and a discarded reading inside files that already existed.  // v4673 -- RE-DERIVED: tools/ship/orphanSets.mjs and its gate arrived, TWO ES modules using closures -- and async/await did NOT move, which is the shape worth noting: BOTH files are pure over in-memory sets, so neither awaits, fetches, renders or asks a device. THREE rows moved where a gate usually moves four (files, ES modules 4012 -> 4014, closures 3878 -> 3880) and nine held. closuresOverThreads did NOT move (3880 / 23 still rounds to 169).  // v4672 -- RE-DERIVED: tools/ship/relativeBudget-selfcheck.mjs arrived, one ES module using closures and TOP-LEVEL await -- the await is section 9 driving the real runQuickSweep on a fixture, which is what makes the round's claim about the SWEEP and not only about selectGates. Four rows moved (files, ES modules 4011 -> 4012, closures 3877 -> 3878, async/await 1541 -> 1542) and eight held: no typed array, no Promise constructor, no fetch, no device. closuresOverThreads did NOT move (3878 / 23 still rounds to 169).  // v4671 -- RE-DERIVED: tools/ship/backlogIntegrity-selfcheck.mjs arrived, one ES module using closures -- only TWO rows moved where a gate usually moves four, because it neither awaits nor fetches: there is nothing to render and nothing to ask a device. closuresOverThreads did NOT move (3877 / 23 still rounds to 169).  // v4670 -- RE-DERIVED: tools/ship/orbBehaviorStates-selfcheck.mjs arrived, one ES module using closures, await, a Promise and fetch -- SIX rows moved where a gate usually moves four, because this one stubs globalThis.fetch to slow the model down and wraps the bridge's callback response in a Promise. closuresOverThreads did NOT move (3876 / 23 still rounds to 169).  // v4669 -- RE-DERIVED: tools/ship/murmurPortTail-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3875 / 23 still rounds to 168).  // v4668 -- RE-DERIVED: tools/ship/murmurSpMix-selfcheck.mjs and tools/ship/gateParses-selfcheck.mjs arrived, TWO ES modules using closures and await -- gateParses awaits its dynamic import of node:vm, which it needs because vm.SourceTextModule is behind a flag and the file re-execs itself to get it. Four rows moved by two apiece, eight held, and closuresOverThreads did NOT move (3874 / 23 still rounds to 168).  // v4664 -- RE-DERIVED: tools/ship/murmurFormation-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3872 / 23 still rounds to 168).  // v4663 -- RE-DERIVED: tools/ship/murmurCadence-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3871 / 23 still rounds to 168).  // v4662 -- RE-DERIVED: tools/ship/murmurClock3-selfcheck.mjs and murmurClock4-selfcheck.mjs arrived, TWO ES modules using closures; Clock4 awaits its render and Clock3 does not, so asyncAwait moved by ONE where the other three rows moved by two -- eight held, and closuresOverThreads did NOT move (3870 / 23 still rounds to 168).  // v4661 -- RE-DERIVED: tools/ship/murmurSingles-selfcheck.mjs and murmurSingles2-selfcheck.mjs arrived, TWO ES modules using closures and await -- four rows moved by two apiece, eight held, and closuresOverThreads did NOT move (3868 / 23 still rounds to 168).  // v4660 -- RE-DERIVED: tools/ship/murmurIgniteFour-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3866 / 23 still rounds to 168).  // v4659 -- RE-DERIVED: tools/ship/murmurIgniteAxis-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3865 / 23 still rounds to 168).  // v4658 -- RE-DERIVED: tools/ship/murmurComplete-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3864 / 23 still rounds to 168).  // v4656 -- RE-DERIVED: tools/ship/murmurGesture-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3863 / 23 still rounds to 168).  // v4655 -- RE-DERIVED: tools/ship/murmurClock2-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3862 / 23 still rounds to 168).  // v4654 -- RE-DERIVED: tools/ship/murmurClock-selfcheck.mjs arrived, one ES module using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3861 / 23 still rounds to 167).  // v4653 -- RE-DERIVED: the two st.drive gates arrived, both ES modules using closures and await -- four rows moved, eight held, and closuresOverThreads did NOT move (3860 / 23 still rounds to 167).  // v4650 -- RE-DERIVED: tools/ship/murmurTempo-selfcheck.mjs arrived, one ES module using closures and one await (its render section) -- four rows moved, eight held, and closuresOverThreads did NOT move (3858 / 23 still rounds to 167).  // v4649r -- RE-DERIVED: tools/ship/pixelWorst.mjs arrived, one ES module with no closure, no await and no device call in it -- TWO rows moved and ten held. v4649 -- RE-DERIVED: tools/ship/fixtureLitter.mjs arrived, one ES module using closures and one await (a dynamic import in playwrightResolve-selfcheck at v4648r) -- four rows moved, eight held. v4647 -- RE-DERIVED after this session's own eleven files; see the note below. v4645 -- RE-DERIVED AT THE main MERGE over the merged tree. RE-DERIVED AT THE main MERGE: 4169 on this branch, 4172 on main, 4260 merged -- LESS than the sum, which is why it is run
