...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    files: 4313,               // v4676: 4311 -> 4313 for render/flowReconcile.mjs and its gate -- FSR3's reconciliation of the two motion fields. v4645 -- RE-DERIVED AT THE main MERGE over the merged tree. RE-DERIVED AT THE main MERGE: 4169 on this branch, 4172 on main, 4260 merged -- LESS than the sum, which is why it is run
    ...
    esModules: 4013, closures: 3872, asyncAwait: 1536, typedArrays: 1145, promises: 370,
