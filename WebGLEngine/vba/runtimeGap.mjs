...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    esModules: 3799, closures: 3678, asyncAwait: 1427, typedArrays: 1042, promises: 350,
    ...
    closuresOverThreads: 167,     // 3678 / 22 at v4546 -- 167.2, unmoved as an integer
