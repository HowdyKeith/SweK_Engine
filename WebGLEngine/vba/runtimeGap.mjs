...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    // v4650 -- RE-DERIVED: three files arrived (tools/ship/wasmTeardown.mjs, its gate, and the CJS hook
    ...
    // v4653 -- RE-DERIVED: two files arrived (tools/ship/declaredCost.mjs and its gate). THREE rows
