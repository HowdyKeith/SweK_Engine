...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    files: 4174,                  // v4637 -- RE-TAKEN 4172 -> 4174 for the two arc/sol gates.  // v4636 -- RE-TAKEN 4170 -> 4172 for the two fathom/geode gates.  // v4622-merge-b -- RE-TAKEN after the actual merge landed: 4135 -> 4160.
    ...
    esModules: 3874, closures: 3752, asyncAwait: 1473, typedArrays: 1073, promises: 366,
