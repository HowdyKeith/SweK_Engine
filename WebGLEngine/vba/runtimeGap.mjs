...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    // v4536 -- RE-TAKEN AT THE MERGE: ES modules 3769 -> 3771, closures 3648 -> 3650, typed arrays
    // 1034 -> 1036, for the two files of the partition-scorer round. The typed-array row moves here where
    // neither of the last two rounds moved it, because a labelling and a visited mask are what that module
    // is made of. THE CONSTRUCTOR NAMES ARE NOT SPELT in this note on purpose: the census strips comments
    // but NOT strings, and a previous round moved this exact row 795 -> 796 on the strength of prose.
    esModules: 3771, closures: 3650, asyncAwait: 1423, typedArrays: 1036, promises: 349,
