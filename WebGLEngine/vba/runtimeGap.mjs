...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    files: 4176,                  // v4638 -- RE-TAKEN 4174 -> 4176 for the two aura/flux gates.  // v4637 -- RE-TAKEN 4172 -> 4174 for the two arc/sol gates.  // v4636 -- RE-TAKEN 4170 -> 4172 for the two fathom/geode gates.  // v4622-merge-b -- RE-TAKEN after the actual merge landed: 4135 -> 4160.
    ...
    esModules: 3876, closures: 3754, asyncAwait: 1475, typedArrays: 1073, promises: 366,
