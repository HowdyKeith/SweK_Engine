...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    esModules: 3801, closures: 3680, asyncAwait: 1427, typedArrays: 1042, promises: 350,
    ...
    closuresOverThreads: 167,     // 3680 / 22 at v4547 -- 167.3, unmoved as an integer
