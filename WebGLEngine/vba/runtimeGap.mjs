...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    esModules: 3798, closures: 3677, asyncAwait: 1427, typedArrays: 1042, promises: 350,
    ...
    closuresOverThreads: 167,     // 3677 / 22 at v4545 -- 167.1, unmoved as an integer
