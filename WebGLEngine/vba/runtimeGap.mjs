...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    files: 4184,                  // v4644 -- RE-TAKEN 4182 -> 4184 for the two SUCCESS-flash gates.  // v4641 -- RE-TAKEN 4180 -> 4182 for the two mh_live gates.  // v4640 -- RE-TAKEN 4178 -> 4180 for the two prism/helix gates.  // v4639 -- RE-TAKEN 4176 -> 4178 for the two duet/chorus gates.  // v4638 -- RE-TAKEN 4174 -> 4176 for the two aura/flux gates.  // v4637 -- RE-TAKEN 4172 -> 4174 for the two arc/sol gates.  // v4636 -- RE-TAKEN 4170 -> 4172 for the two fathom/geode gates.  // v4622-merge-b -- RE-TAKEN after the actual merge landed: 4135 -> 4160.
    ...
    esModules: 3884, closures: 3762, asyncAwait: 1483, typedArrays: 1073, promises: 366,
