...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    esModules: 3802, closures: 3681, asyncAwait: 1427, typedArrays: 1042, promises: 350,
    ...
    closuresOverThreads: 167,     // 3681 / 22 at v4548 -- 167.3, unmoved as an integer
