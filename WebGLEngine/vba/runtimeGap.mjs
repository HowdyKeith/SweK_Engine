...
export const MEASURED_AT_V4462 = Object.freeze({
    ...
    // v4536 -- RE-TAKEN: ES modules 3768 -> 3770, closures 3647 -> 3649 and the typed-array row 1034 ->
    // 1036, for the two files of the partition-scorer round. The typed-array row moves here where the
    // record-shape round did not move it, because a labelling and a visited mask are what this module is
    // made of. THE CONSTRUCTOR NAMES ARE NOT SPELT in this note on purpose: the census strips comments but
    // NOT strings, and a previous round moved this exact row 795 -> 796 on the strength of prose.
    esModules: 3770, closures: 3649, asyncAwait: 1423, typedArrays: 1036, promises: 349,
