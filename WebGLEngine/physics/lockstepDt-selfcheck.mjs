...
// *** v4677 -- process.exitCode, NOT process.exit. A FALSE NEGATIVE THE FIRST PASS MISSED. ***
...
// The v4677 screen (tools/ship/exitBusy.mjs) read this gate ONCE at 4.2 ms of CPU across an awaited 300 ms
