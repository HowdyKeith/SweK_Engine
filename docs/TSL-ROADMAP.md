# TSL and SweK -- the roadmap (written at v4319; step 4 built at v4320, step 5 at v4321, a race painted and the rig page at v4322, linear sampling and the page's generated race at v4323, the vertex stage at v4324, a second shell and a second race at v4325, a texture across the shell boundary at v4326, a sampler at v4327, the ink layout at v4328, the module split and the front-door drawer at v4329, the compute stage at v4331, a pass that reads a buffer at v4336)
...
6. **TSL COMPUTE.** BUILT at v4331, and it is the one place this tree's pair contract does not apply: WebGL2 has no
   ...
   Not built: workgroup-shared or ATOMIC work (the cull pass counts into an atomic<u32> and nothing here does), and
   an INDIRECT dispatch, where the count a pass runs at is itself in a buffer.
