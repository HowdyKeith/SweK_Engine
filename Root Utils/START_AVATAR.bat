@echo off
REM START_AVATAR.bat - "avatar server mode": start the ai-bridge and open the avatar-server
REM hub (avatar-server.html) - the engine seen through the avatar window.
...
start "" http://127.0.0.1:8787/avatar-server.html
